...
namespace KisiDefteriOnline6
{
    public partial class Form1 : Form
    {
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show("Silmek istediðinize emin misinþz ? ", "onay", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        {
            if (e.KeyCode == Keys.Delete) { btnSil.PerformClick(); }
